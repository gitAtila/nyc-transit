...
python transit_taxi_cost_II.py ~/Documents/Projeto_2020/passenger_trips/all_modes.csv ~/Documents/Projeto_2020/passenger_trips/all_modes.csv ~/Documents/Projeto_2020/matching/transit_taxi/survey/temporal_spatial_real_inf.csv ~/Documents/Projeto_2020/matching/transit_taxi/survey/detour_factor_inf.csv ~/Documents/Projeto_2020/matching/transit_taxi/survey/costs_real_prop_inf.csv
'''
...
def compute_integration_costs(dict_transit_private_trip, dict_taxi_private_trip, df_matches):
    ...
    for index, matching in df_matches.iterrows():
        ...
        and matching['taxi_arrival_time_transit_stop'] < matching['taxi_destination_time']:
            ...
            detour_factor = (sharing_duration - private_duration)/private_duration
            # detour_factor = 1/taxi_time_relative_detour

            # print private_duration, sharing_duration, detour_factor
