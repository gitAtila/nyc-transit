...
list_extra_cost_real, list_saving_money_real = extra_cost_saving_money(df_max_benefit_real)
list_extra_cost_10min_5x, list_saving_money_10min_5x = extra_cost_saving_money(df_max_benefit_10min_5x)
list_extra_cost_10min_10x, list_saving_money_10min_10x = extra_cost_saving_money(df_max_benefit_10min_10x)
list_extra_cost_20min_5x, list_saving_money_20min_5x = extra_cost_saving_money(df_max_benefit_20min_5x)
list_extra_cost_20min_10x, list_saving_money_20min_10x = extra_cost_saving_money(df_max_benefit_20min_10x)
