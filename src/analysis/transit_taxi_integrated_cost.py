...
transit_integration_car_path = argv[4]
chart_path = argv[5]
...
df_transit_car_trips = pd.read_csv(transit_integration_car_path)
df_transit_car_trips['date_time'] = pd.to_datetime(df_transit_car_trips['date_time'])
...
list_transit_shared_integrated_cost = []
list_transit_private_integrated_cost = []
for integration in list_best_integrations:
    ...
    transit_car_trip =  df_transit_car_trips[(df_transit_car_trips['car_trip_id'] == integration['car_trip_id'])\
    & (df_transit_car_trips['transit_trip_id'] == integration['transit_trip_id'])]
    # print transit_car_trip
    ...
    transit_car_cost = nyc_taxi_cost(transit_car_trip.iloc[0]['date_time'], transit_car_trip.iloc[-1]['distance'], 0)
    ...
    print 'transit_individual_integrated_cost', transit_car_cost
    ...
    # break
    # transit_passenger_shared_cost = transit_integrated_cost
    # transit_passenger_private_cost = transit_car_cost

    # list_taxi_saving_money.append(taxi_passenger_saving_money)
    # list_transit_extra_cost.append(transit_passenger_cost)
    list_transit_shared_integrated_cost.append(transit_integrated_cost)
    list_transit_private_integrated_cost.append(transit_car_cost)

    # break

plot_cdf_two_curves(list_transit_shared_integrated_cost, list_transit_private_integrated_cost,\
'integrated shared cost', 'integrated private cost', 'dollars', chart_path)
